...
export default function SpecialTitle({ title }: Props) {
  ...
  return (
    <Canvas style={{ width: 300, height: 55 }}>
      <Group opacity={0.8} blendMode={'overlay'}>
        <Oval opacity={0.5} x={0} y={25} width={190} height={10} style={'fill'}>
          <Shadow shadowOnly blur={10} color={PrimaryColors[theme].x.primary} dx={0} dy={0} />
        </Oval>
        <Oval opacity={0.5} x={110} y={25} width={190} height={10} style={'fill'}>
